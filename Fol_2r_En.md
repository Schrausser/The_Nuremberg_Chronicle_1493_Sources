...
**Moses**, the divine prophet and historian who lived nearly 700 years before the Trojan War, teaches that God, the planner and creator of all things, first created the heaven and established it as the seat of the Creator God himself in order to accomplish this work. Then he founded the earth and subordinated it to the heaven. He shrouded the earth in darkness, meaning it is without its own enlightment[^1] unless it receives light from heaven. There he instituted eternal light, the heavenly spirits and eternal life; to the earth, however, he gave darkness, earthly spirits and death.[^2]
...
This is probably how the Saracens understood[^19] it when they said that the angels had been led by God from *darkness* into the light and filled with eternal joy. However, some of them forgot their divine character[^20], changed from good to evil[^21] through their own *own* reversal[^22] and became devils (what we call criminals[^23]).[^24]

(ad 1) The earth was void, that is (as **Jerome** and **the Seventy**[^25] suggest) invisible and unjoined[^26] and because of this confused[^27] state called *Abyss*, which the Greeks call *Chaos*. This is[^28] *three-dimensional* matter[^29], extended to the greatest depths[^30].
...
[^6]: attributed to the 'Summa super Sententias' (Petrus, [1484](https://doi.org/10.3931/e-rara-18241), Book II, Section 1), it deals with Plato's view of eternal, unformed matter, Aristotle's claim of an eternal world and Epicurus's theory of atomic collision.  
[^7]: 't[ame]n'.  
[^8]: 'prude[n]tissim[us]'.  
[^9]: 'vt'.  
...
[^16]: discusses the Christian theological concept of creation from nothing (<ins>*creatio ex nihilo*</ins>).  
[^17]: 'materia[m] de q[ua] faceret' and 'ein materi daraus er machet'.  
[^18]: c.f. Lactantius ([1497](https://books.google.com/books?id=qGsnghsi3uUC), Book II 8.8), he argued against ancient Greek philosophies claiming God created the world from *pre-existing* matter.  
[^19]:  from the 'Etymologiae'(De Seville, [1802](https://books.google.com/books?id=wb8Z_vlSyJwC), Book VIII, Chapter xi, *De diis gentium*), written in the <ins>*early*</ins> 7th c., around 610 AD. In this case, it can be assumed that the reference is to the *Saracens* from the 4th c., nomadic tribes of the Syrian-Arabian desert, and therefore there is no reference to *Islam*. Rather, it seems to refer to the *pivotal* events around 378 AD, in connection with the devastating defeat of the Western Roman Empire against the Goths at Adrianople and the involvement of the *Saracens* under *Mavia* (*Mawiyya*), a female Arab ruler who had recently led a revolt against the Roman Empire in southern Syria and subsequently <ins>*switched sides*</ins>. Interestingly, the story of the *Saint* ***Moses*** *the Bishop of the Arabs* also falls into this context - not to be confused with the similarly named ***Moses*** *the Black*, a <ins>converted criminal</ins> who operated in the same region at the same time (also known as *Moses the Strong*, *Moses the Abyssinian*, *Moses the Indian*, *Abba Moses the Robber*, *Moses Murin* or *Moses the Ethiopian* etc.).  
[^20]: 'indolis' and 'einpildung'.  
[^21]: 'ex bono p[er] se malu[m] effectu[m]' and 'vo[m] gůtten zum ubel getretten'.   
[^22]: 'verkerung', perversion.  
[^23]: 'greci diabolu[m] appelant: nos crimi[n]atore[m] vocam[us]'.  
[^24]: from the 'Heptaplus' (Mirandola & Mirandola, [1601](https://doi.org/10.3931/e-rara-61217)), Book 1, Chapter 1).  
[^25]: 'septinge[n]ta', 700 vs. 'die .lxx. auslege[r]'.  
[^26]: 'i[n]co[m]posita' and 'vnzesamen gefügt', refers to the Latin translations of the Hebrew 'tohu wa-bohu' (formless and empty) from Genesis 1:2 (c.f. Jiménez de Cisneros, [1517](https://doi.org/10.3931/e-rara-46695)).  
[^27]: '[con]fusio[n]e' and 'zestrewlichkeit'.  
[^28]: 'i[d est]'.  
[^29]: 'materia[m] trino dime[n]su' and 'materi mit driueltiger ermessung'.  
[^30]: 'i[n] altissimas profunditates extensam'.  
[^31]: 'senario numero' and 'in sechser zall'.  
[^32]: 'que in trigonu[m] surga[n]t'.  
[^33]: from the 'Heptaplus', (Mirandola & Mirandola, [1601](https://doi.org/10.3931/e-rara-61217)), in classical and medieval number theory, 6 is the first *perfect number* because it is equal to the sum of its proper divisors (1+2+3=6).
