...
It should be noted that the *Second* and *First* days, *Order* and *Creation*, take place in **R**, while in **VR** from *Day Three* onward, *Design* and further *Ornamentation* are only indirectly recognized as a logical, recursive predecessor image. This representation is thus continued retrospectively in the *Preface*:
